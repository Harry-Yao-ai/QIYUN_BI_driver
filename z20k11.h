...
#define DUT_TYPE	"Z20K"								/* 4-character DUT type to display */
#define DUT_SW_REV	"1.00"								/* 4-character DUT s/w rev to display */

#define SCROLL_NAME	"QIYUN Z20K11 Burn-in    "			/* Scrolls after power up */
...
#define EDT_CLK_LOW			OUT0_31 &= 0xFFFFFF3F		/* CLR THE BITS for output low  OP 24/25  */
#define EDT_CLK_HIGH		OUT0_31 |= 0x000000C0		/* SET THE BITS for output high OP 24/25  */
...
#define BIST_RESUME_LOW 	OUT0_31 &= 0xFFFFFFF3		/* CLR THE BIT  OP.28/29 */
#define BIST_RESUME_HIGH	OUT0_31 |= 0x0000000C		/* SET THE BIT  OP.28/29 */

#define BIST_INVOKE_LOW 	OUT0_31 &= 0xFFFF3FFF		/* CLR THE BITS OP.16/17 */
#define BIST_INVOKE_HIGH	OUT0_31 |= 0x0000C000		/* SET THE BITS OP.16/17 */
...
#define FlashAccessKey1	0xF38F44E7						/* The access key to enter flash test mode */
#define FlashAccessKey2	0x00000007						/* The access key to enter flash test mode */
#define Access_Key		0xBCEF9279						/* ACCESS KEY for QIYUN test mode entry */
#define FuncTest_High	0x80000000						/* TCU high 32 bits */
#define FuncTest_Low	0x00000001						/* TCU low 32 bits for function test mode*/
#define MBIST_High		0x80003C02						/* add AOD and CORE trim in TCU reg */
//#define MBIST_High		0x80003C00
#define MBIST_Low		0x64100002						/* TCU low 32 bits for RAMBIST mode*/
//#define MBIST_Low		0x00100002						/* TCU low 32 bits for RAMBIST mode*/
#define BISCAN_High		0x80003C02
#define BISCAN_Low	 	0x64100081						/* (32LSB) EDT Test Kompress B/I SCAN no DAC override */
...
#define FLASH_TEST_REG	0x4002000C	/* flash test reg */

#define PMC_VDD5V_CSR	0x4007D010	/* PMU control and status register */
#define PMC_LOCK  		0x4007D014	/* PMU user lock register */
#define LVR_DISABLE 	0x00000202	/* SWD write 32-bit and disable VDD LVR */
#define	PMC_USER_UNLOCK	0x94730000	/* allow writing to PMU registers from 0x00 to 0x10 */
...
#define ECIDLoc1 	 0x02101000		/* Read ECID data directly out of SIM UID  H Registers */
#define ECIDLoc2 	 0x02101004		/* Read ECID data directly out of SIM UID MH Registers */
#define ECIDLoc3 	 0x02101008		/* Read ECID data directly out of SIM UID ML Registers */
#define ECIDLoc4 	 0x0210100C		/* Read ECID data directly out of SIM UID  L Registers */

// Consolidated updates for NVM & HTOL Status

#define StatusAddr1  0x00000000		/* This is where NVM cycling status is stored  */
#define StatusAddr2  0x00000010
#define StatusAddr3  0x00000020
#define HTOLStatusAddr	0x00000030

#define ADC_Ver_Loc	 0x40064000
//#define SecurityLoc  0x0000040C		/* NVOPT Register contains security bits */

#define ADC_Ver_ID	 0x00060000
//#define SecurityVal  0xFFFFFFFE

#define Populated	 0x00060000		/* used to eliminate reflected data when reading unpopulated sockets */
#define Unpopulated	 0xFFFFFFFF		

#define TempSenseLoc 0x1FFFC008		/* stored in RAM */
#define BandgapLoc	 0x1FFFC004		/* stored in RAM */
#define NVMChkSumLoc 0x1FFFC008		/* checksum calculated using word-wise XOR NVM  */
#define NVMStatusLoc 0x1FFFC00C

#define SRAM_START	 0x1FFFC000
...
#define TimeSegment (UINT32)2		/* execute stresses in discrete segments to allow real time termination */
...
#define ECB1_RUN	 (UINT16)10000			/* ECB limits set for normal operation and execution */
#define ECB2_RUN	 (UINT16)5000			/* ECB limits set for normal operation and execution */
...
#define POR_REARM1 (UINT16)1200				/* mV, must be below minimum POR de-assertion */
#define POR_REARM2 (UINT16)1200				/* mV, must be below minimum POR de-assertion */
